...
static inline int is_LDR_imm(uint32_t instr)                 { return ( ( ((instr) >> 25) & 0x1) == 0x0 ) && ( ( ( ((instr) >> 20) & 0x5) == 0x1 ) && ( ( ((instr) >> 20) & 0x17) != 0x3 ) ); } // 0b0 and (0bxx0x1 and not 0b0x011)
...
static inline int is_LDRB_imm(uint32_t instr)                { return ( ( ((instr) >> 25) & 0x1) == 0x0 ) && ( ( ( ((instr) >> 20) & 0x5) == 0x5 ) && ( ( ((instr) >> 20) & 0x17) != 0x7 ) ); } // 0b0 and (0bxx1x1 and not 0b0x111)
